...
public class GameStartScreen extends JFrame {
  /**
   * Constructor
   * Gets passed the level number and text about the
   * level to print out.
   * @param levelNum
   * @param levelText
   */
  public GameStartScreen(int levelNum, String levelText) {
    ...
    String text = "<html><body><div style='width:500px; text-align:center; padding:20px'><h1 style='font-size:60px; margin-bottom:50px'> Level "
        + levelNum
